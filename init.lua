...
require('lazy').setup({
  { 'rcarriga/nvim-dap-ui', dependencies = { 'mfussenegger/nvim-dap', 'nvim-neotest/nvim-nio' } },
  {
    ...
    config = function()
      ...
      dap.adapters.python = {
        type = 'executable',
        command = 'pythonw.exe', -- Ajuste o caminho para o seu pythonw.exe
        args = { '-m', 'debugpy.adapter' },
        options = {
          -- No Windows, usa CREATE_NO_WINDOW para evitar a janela de console
      ...
      dap.configurations.python = {
        {
          ...
          name = 'Launch file',
          program = '${file}',
          console = 'internalConsole', -- Sem console visível
        },
      }
  ...
  },
  {
    ...
    config = function()
      require('dap-python').setup 'pythonw.exe'
    end,
    lazy = true,
  },
